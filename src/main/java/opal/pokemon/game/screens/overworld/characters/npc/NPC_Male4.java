...
public class NPC_Male4 extends NPC {
    ...
    public void getNPCImage() {
        view.up1 = view.setup("/images/characters/npc/male_4/up_1");
        view.up2 = view.setup("/images/characters/npc/male_4/up_2");
        view.up3 = view.setup("/images/characters/npc/male_4/up_3");
        view.left1 = view.setup("/images/characters/npc/male_4/left_1");
        view.left2 = view.setup("/images/characters/npc/male_4/left_2");
        view.left3 = view.setup("/images/characters/npc/male_4/left_3");
        view.down1 = view.setup("/images/characters/npc/male_4/down_1");
        view.down2 = view.setup("/images/characters/npc/male_4/down_2");
        view.down3 = view.setup("/images/characters/npc/male_4/down_3");
        view.right1 = view.setup("/images/characters/npc/male_4/right_1");
        view.right2 = view.setup("/images/characters/npc/male_4/right_2");
        view.right3 = view.setup("/images/characters/npc/male_4/right_3");
    }
