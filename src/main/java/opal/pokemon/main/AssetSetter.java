...
public class AssetSetter {
    ...
    public void setNPC(NPC[] npc) {
        ...
        npc[0].model.worldX = 12 * gp.tileSize;
        npc[0].model.worldY = 40 * gp.tileSize;
        npc[0].model.direction = "up";

        npc[1] = new NPC_Female1(gp);
        npc[1].model.worldX = 23 * gp.tileSize;
        npc[1].model.worldY = 39 * gp.tileSize;

        npc[2] = new NPC_Female2(gp);
        npc[2].model.worldX = 9 * gp.tileSize;
        npc[2].model.worldY = 47 * gp.tileSize;

        npc[3] = new NPC_Female3(gp);
        npc[3].model.worldX = 52 * gp.tileSize;
        npc[3].model.worldY = 8 * gp.tileSize;

        npc[4] = new NPC_Male6(gp);
        npc[4].model.worldX = 5 * gp.tileSize;
        npc[4].model.worldY = 12 * gp.tileSize;
        npc[4].model.direction = "left";

        npc[5] = new NPC_Male4(gp);
        npc[5].model.worldX = 19 * gp.tileSize;
        npc[5].model.worldY = 12 * gp.tileSize;
        npc[5].model.direction = "up";

        npc[6] = new NPC_Female5(gp);
        npc[6].model.worldX = 71 * gp.tileSize;
        npc[6].model.worldY = 9 * gp.tileSize;

        npc[7] = new NPC_Male3(gp);
        npc[7].model.worldX = 90 * gp.tileSize;
        npc[7].model.worldY = 7 * gp.tileSize;
        npc[7].model.direction = "right";

        npc[8] = new NPC_Male5(gp);
        npc[8].model.worldX = 87 * gp.tileSize;
        npc[8].model.worldY = 43 * gp.tileSize;

        npc[9] = new NPC_Female4(gp);
        npc[9].model.worldX = 51 * gp.tileSize;
        npc[9].model.worldY = 63 * gp.tileSize;
        npc[9].model.direction = "up";

        npc[10] = new NPC_Female6(gp);
        npc[10].model.worldX = 26 * gp.tileSize;
        npc[10].model.worldY = 76 * gp.tileSize;

        npc[11] = new NPC_Female6(gp);
        npc[11].model.worldX = 25 * gp.tileSize;
        npc[11].model.worldY = 76 * gp.tileSize;
        ...
        npc[12].model.worldX = 11 * gp.tileSize;
        npc[12].model.worldY = 77 * gp.tileSize;

        npc[13] = new NPC_NurseJoy(gp);
        npc[13].model.worldX = 11 * gp.tileSize;
        npc[13].model.worldY = 86 * gp.tileSize;


        npc[14] = new NPC_Male1(gp);
        npc[14].model.worldX = 60 * gp.tileSize;
        npc[14].model.worldY = 90 * gp.tileSize;
        npc[14].model.direction = "up";


        npc[15] = new NPC_Machop(gp);
        npc[15].model.worldX = 59 * gp.tileSize;
        npc[15].model.worldY = 89 * gp.tileSize;
        npc[15].model.direction = "right";

        npc[16] = new NPC_Machop(gp);
        npc[16].model.worldX = 70 * gp.tileSize;
        npc[16].model.worldY = 84 * gp.tileSize;
        npc[16].model.direction = "left";

        npc[17] = new NPC_Machop(gp);
        npc[17].model.worldX = 85 * gp.tileSize;
        npc[17].model.worldY = 93 * gp.tileSize;

        npc[18] = new NPC_Male2(gp);
        npc[18].model.worldX = 84 * gp.tileSize;
        npc[18].model.worldY = 88 * gp.tileSize;
    }
}
